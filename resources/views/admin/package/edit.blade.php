...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('admin/package/'.$package->id)}}" enctype="multipart/form-data" data-parsley-validate="">
            @csrf
            @method('put')
            <div class="card">
                ...
                <div class="card-body card_form">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="name" value="{{$package->name}}" required="" data-parsley-required-message="Please enter the name of the package">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('no_of_rstrt') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" name="no_of_rstrt" value="{{$package->no_of_rstrt}}" required="" data-parsley-required-message="Please enter the number of restaurant">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('no_of_emp') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" name="no_of_emp" value="{{$package->no_of_emp}}" required="" data-parsley-required-message="Please enter the number of employees">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('no_of_months') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" name="no_of_months" value="{{$package->no_of_months}}" required="" data-parsley-required-message="Please enter the number of months">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('price') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" name="price" value="{{$package->price}}" required="" data-parsley-required-message="Please enter the price">
                            @if ($errors->has('price'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row custom_form_group">
                        ...
                        <div class="col-sm-7 pt-2">
                            ...
                            <input type="radio" class="ml-2" name="status" value="0" {{ $package->status == 0 ? 'checked' : '' }}> Inactive
                        </div>
                    </div>
                </div>
