            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{url('admin/add-more/'.$order->slug.'/'.$order->rstrt_slug)}}" class="btn btn-md btn-success waves-effect card_top_button"><i class="fa fa-plus"></i> Add More</a>
                        <a href="{{ url('admin/submit-edit/'.$order->slug.'/'.$order->rstrt_slug) }}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Submit Edit</a>
                    </div>
