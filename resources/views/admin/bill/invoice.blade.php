                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            {{-- <button class="btn btn-md btn-primary waves-effect card_top_button" data-backdrop='static' data-keyboard='false'><i class="fa fa-money" aria-hidden="true"></i> Take Bill</button> --}}
                        </div>
                ...
                <div class="card-body" id="section-to-print">
                    ...
                    <div class="row" style="border-radius: 0px;">
                        <div class="col-md-3 offset-9">
                            ...
                            <hr>
                            <h3 class="text-right">{{ $order->orderRestaurant->currency_symbol }} {{ $order->billInfo->amount + $order->billInfo->vat }}</h3>
                        </div>
                    </div>
                </div>
