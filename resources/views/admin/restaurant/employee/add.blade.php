...
<div class="modal fade" id="addEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/employee/'.$restaurant->slug) }}" method="post" enctype="multipart/form-data" data-parsley-validate="" id="formAddEmployee">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="emailpassword" class="form-control" name="email" value="{{old('email')}}" required="" data-parsley-required-message="Please enter email">
                            @if ($errors->has('email'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control" name="password" value="{{old('password')}}" required="" data-parsley-required-message="Please enter password" id="password">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control" name="password_confirmation" value="{{old('password_confirmation')}}" required="" data-parsley-equalto="#password" data-parsley-required-message="Please confirm the password" data-parsley-equalto-message="Password Unmatched">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="phone" value="{{old('phone')}}" required="" data-parsley-required-message="Please enter phone">
                            @if ($errors->has('phone'))
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-sm-9">
                            ...
                            data-parsley-required-message="Please select a role">
                                ...
                                @foreach($roles as $role)
                                    @if(Auth::user()->role_id == 3 && $role->role_id == 3)
                                    @else
