...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('admin/restaurant')}}" enctype="multipart/form-data" data-parsley-validate="">
            @csrf
            <div class="card">
                ...
                <div class="card-body card_form">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <script>
                                Swal.fire({
                                  title: 'Restaurant limit is over!',
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('url') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="url" value="{{old('url')}}" required="" data-parsley-required-message="Please enter url">
                            @if ($errors->has('url'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    @if(Auth::user()->role_id == 2)
                        <input type="text" hidden value="{{ $client_id }}" name="client_id">
                    @endif
                    <div class="form-group row custom_form_group">
