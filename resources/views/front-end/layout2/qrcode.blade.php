        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto" id="myDIV">
                    <li class="nav-item">
                        <a href="#" class="nav-link smooth-s" onclick="printme()"><i class="fa fa-print"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    {{-- <p class="text-center" style="margin-top: 30px">Triva IT Ltd.</p> --}}
                </div>
            </div>
        </div>
    </section>
